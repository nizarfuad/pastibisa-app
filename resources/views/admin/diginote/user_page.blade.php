    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-header">
                <h4>Pembukuan Nota Digitalmu</h4>
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                            ...
                            <tr>
                            <td>{{ $i++ }}</td>
                            <td>@if ($d->verify_id == 1) <i class="fas fa-lock"></i> @else @endif {{ $d->keperluan }}</td>
                            <td>{{ $d->format }}</td>
                            <td>@currency($d->multiply)</td>
                            <td><div class="badge badge-{{ $d->tipes->color }}">{{ $d->tipes->tipe }}</div></td>
                            <td><a type="button" class="btn btn-sm btn-icon btn-info" href="/mydiginotes/{{ $d->id }}" ><i class="fas fa-list"></i></a></td>
                            </tr>
                            @endforeach
